-- combined_for_paste_v8.sql
-- v7 superseti + L3 güvenlik düzeltmesi:
--   * public.is_admin() SECURITY DEFINER helper fonksiyonu eklendi
--   * notifications RLS politikalari is_admin() kullaniyor
-- Sebep: profiles RLS politikalari degisirse notifications policy'leri sessizce
-- bozulmasin. is_admin() SECURITY DEFINER oldugu icin profiles RLS'inden bagimsizdir.
