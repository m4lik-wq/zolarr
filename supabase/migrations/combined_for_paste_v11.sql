-- combined_for_paste_v11.sql
-- v10 superseti + Faz 13 hazirligi:
--   * pgvector extension etkinlestirildi
--   * embeddings tablosu eklendi (RAG icin doc_type/doc_id + 1024d vector)
--   * match_embeddings RPC eklendi (cosine similarity ile top-K)
