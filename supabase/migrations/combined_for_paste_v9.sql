-- combined_for_paste_v9.sql
-- v8 superseti + Faz 10 hazirligi:
--   * profiles.email_preferences (jsonb) eklendi (default opt-in tum kategoriler)
--   * profiles.unsubscribe_secret (text) eklendi (HMAC unsubscribe token uretimi icin)
