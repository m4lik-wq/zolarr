-- combined_for_paste_v10.sql
-- v9 superseti + Faz 11 hazirligi:
--   * suppliers tablosu eklendi (tedarikci sync icin)
--   * supplier_products tablosu eklendi (urun -> tedarikci eslesmesi + son fiyat/stok)
